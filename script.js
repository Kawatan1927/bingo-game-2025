...
const prizes = {
    ...
    silver: [
        ...
        { id: 2, name: '日本酒 一升瓶', image: 'images/silver-prize-2.jpg', selected: false, description: '何か説明が入ります。' },
        { id: 3, name: '布団乾燥機', image: 'images/silver-prize-3.jpg', selected: false, description: '何か説明が入ります。' },
        { id: 4, name: 'あきたこまち 10kg', image: 'images/silver-prize-4.jpg', selected: false, description: '何か説明が入ります。' },
        ...
        { id: 10, name: 'ビールギフト', image: 'images/silver-prize-10.jpg', selected: false, description: '何か説明が入ります。' },
