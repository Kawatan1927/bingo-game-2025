...
const prizes = {
    gold: [
        { id: 16, name: 'iPad', image: 'images/gold-prize-1.jpg', selected: false , description: '第10世代 Wi-Fiモデル(64GB)' },
        { id: 17, name: 'チェア', image: 'images/gold-prize-2.jpg', selected: false , description: 'COFO Chair Pro ブラック' },
        { id: 18, name: 'Bluetooth ヘッドホン', image: 'images/gold-prize-3.jpg', selected: false , description: 'SONY ノイズキャンセリング対応' },
        { id: 19, name: 'コーヒーメーカー', image: 'images/gold-prize-4.jpg', selected: false , description: '全自動 /ミル付き' },
        { id: 20, name: 'ゲーミングモニター', image: 'images/gold-prize-5.jpg', selected: false , description: '27型 /WQHD(2560×1440）' },
        { id: 21, name: '水なし自動調理鍋', image: 'images/gold-prize-6.jpg', selected: false , description: 'HEALSIO ホットクック' },
        { id: 22, name: '除湿機', image: 'images/gold-prize-7.jpg', selected: false , description: 'コンプレッサー方式 /木造10畳まで' },
        { id: 23, name: 'オーブンレンジ', image: 'images/gold-prize-8.jpg', selected: false , description: '日立 27L 1000W' },
        { id: 24, name: 'ワイヤレスイヤホン', image: 'images/gold-prize-9.jpg', selected: false , description: 'SONY ノイズキャンセリング対応' },
        { id: 25, name: 'Dyson 掃除機', image: 'images/gold-prize-10.jpg', selected: false , description: 'V8 Slim Fluffy Extra' },
        { id: 26, name: 'ReFaヘッドマッサージ', image: 'images/gold-prize-11.jpg', selected: false , description: 'ReFa ビューテック ヘッドスパ' },
        { id: 27, name: 'Wi-Fiルーター', image: 'images/gold-prize-12.jpg', selected: false , description: 'Wi-Fi 7(be) /IPv6対応' },
        { id: 28, name: 'ReFa シャワーヘッド', image: 'images/gold-prize-13.jpg', selected: false , description: 'ReFa FINE BUBBLE U' },
        { id: 29, name: 'Nintendo Switch Lite', image: 'images/gold-prize-14.jpg', selected: false , description: 'カラー：ターコイズ'  },
        { id: 30, name: 'ドライヤー', image: 'images/gold-prize-15.jpg', selected: false , description: 'プラズマクラスタードライヤー' },
    ],
    silver: [
        { id: 1, name: 'ヒツジのいらない枕', image: 'images/silver-prize-1.jpg', selected: false, description: '至極 テンセル枕カバー付き' },
        { id: 2, name: '日本酒', image: 'images/silver-prize-2.jpg', selected: false, description: '写真はイメージです。' },
        { id: 3, name: '布団乾燥機', image: 'images/silver-prize-3.jpg', selected: false, description: 'アイリスオーヤマ マット無タイプ' },
        { id: 4, name: 'あきたこまち 10kg', image: 'images/silver-prize-4.jpg', selected: false, description: 'あきたこまち 10kg' },
        { id: 5, name: 'ホットカーペット', image: 'images/silver-prize-5.jpg', selected: false, description: '2畳相当' },
        { id: 6, name: '加湿器', image: 'images/silver-prize-6.jpg', selected: false, description: 'ハイブリットW抗菌加湿器' },
        { id: 7, name: '電動歯ブラシ', image: 'images/silver-prize-7.jpg', selected: false, description: 'BRAUN PRO 600' },
        { id: 8, name: 'ゴルフボール 1ダース', image: 'images/silver-prize-8.jpg', selected: false, description: 'NEW PRO V1x' },
        { id: 9, name: 'プラレール レールキット', image: 'images/silver-prize-9.jpg', selected: false, description: '20のレイアウトでかっこよく走らせよう！DXレールキット' },
        { id: 10, name: 'ビールギフト', image: 'images/silver-prize-10.jpg', selected: false, description: '写真はイメージです。' },
        { id: 11, name: 'ドンジャラ ちいかわ', image: 'images/silver-prize-11.jpg', selected: false, description: 'ドンジャラNEO ちいかわ' },
        { id: 12, name: 'マッサージガン', image: 'images/silver-prize-12.jpg', selected: false, description: '筋膜リリースガン' },
        { id: 13, name: 'ReFa ヘアブラシ', image: 'images/silver-prize-13.jpg', selected: false, description: 'ReFa HEART BRUSH for SCALP' },
        { id: 14, name: 'サウナハット', image: 'images/silver-prize-14.jpg', selected: false, description: 'ごリラックス ととのいサウナカラーハット' },
        { id: 15, name: '缶詰おつまみ 3缶セット', image: 'images/silver-prize-15.jpg', selected: false, description: 'ウイスキー･ハイボールに合う缶つま' },
    ],
};
